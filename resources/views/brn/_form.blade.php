<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-BrnCode-error">
        {!! Form::label("BrnCode","প্রোডাক্টের নামঃ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("BrnCode",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="BrnCode-error" class="help-block"></span>
        </div>
    </div>
