...
<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-GraceId-error">
        {!! Form::label("GraceId","গ্রেচ আইডি",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("GraceId",null,["class"=>"form-control required","id"=>"focus"]) !!}
            <span id="GraceId-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-SomitiName-error">
        {!! Form::label("SomitiName","সমিতির নাম",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-MemberName-error">
        {!! Form::label("MemberName","সদস্যের নাম",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-GraceStartTime-error">
        {!! Form::label("GraceStartTime","গ্রেচ শুরুর তারিখ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-GraceEndDate-error">
        {!! Form::label("GraceEndDate","গ্রেচ সমাপ্তি তারিখ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-Description-error">
        {!! Form::label("Description","বর্ণনা",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
