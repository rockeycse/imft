...
<table class="table table-bordered table-striped">
    ...
    <tr>
        ...
        <th>
            <a href="javascript:ajaxLoad('division/list?field=DivisionCode&sort={{Session::get("division_sort")=="asc"?"desc":"asc"}}')">
                Division Code
            </a>
            <i style="font-size: 12px"
               class="glyphicon  {{ Session::get('division_field')=='DivisionCode'?(Session::get('division_sort')=='asc'?'glyphicon-sort-by-alphabet':'glyphicon-sort-by-alphabet-alt'):'' }}">
            </i>
        </th>
        <th>
            <a href="javascript:ajaxLoad('division/list?field=testfield&sort={{Session::get("division_sort")=="asc"?"desc":"asc"}}')">
                Division Code
            </a>
            <i style="font-size: 12px"
               class="glyphicon  {{ Session::get('division_field')=='testfield'?(Session::get('division_sort')=='asc'?'glyphicon-sort-by-alphabet':'glyphicon-sort-by-alphabet-alt'):'' }}">
            </i>
        </th>
        <th>
            <a href="javascript:ajaxLoad('division/list?field=unitprice&sort={{Session::get("division_sort")=="asc"?"desc":"asc"}}')">
                Unitprice
            </a>
            <i style="font-size: 12px"
               class="glyphicon  {{ Session::get('division_field')=='unitprice'?(Session::get('division_sort')=='asc'?'glyphicon-sort-by-alphabet':'glyphicon-sort-by-alphabet-alt'):'' }}">
            </i>
        </th>
    ...
    @foreach($divisions as $key=>$division)
        <tr>
            ...
            <td>{{$division->testfield}}</td>
            <td align="right">$ {{$division->unitprice}}</td>
