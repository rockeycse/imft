<div class="col-md-12">
    ...
    <div class="form-group required col-md-6" id="form-ProductNameEng-error">
        {!! Form::label("ProductNameEng","প্রোডাক্টের নাম(ইংরেজি)",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-ProductNameBanglaShort-error">
        {!! Form::label("ProductNameBanglaShort","প্রোডাক্টের বাংলা নাম(সংক্ষিপ্ত)",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-ProductNameBanglaFull-error">
        {!! Form::label("ProductNameBanglaFull","প্রোডাক্টের বাংলা নাম(পূর্ণ)",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-ProductType-error">
        {!! Form::label("ProductType"," প্রোডাক্টের ধরণ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("ProductType",null,["class"=>"form-control required"]) !!}
            <span id="ProductType-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-ServiceChargeRate-error">
        {!! Form::label("ServiceChargeRate","সার্ভিস চার্জ রেট",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::nuber("ServiceChargeRate",null,["class"=>"form-control required"]) !!}
            <span id="ServiceChargeRate-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-Duration-error">
        {!! Form::label("Duration","মেয়াদ(মাস)",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-MainProductName-error">
        {!! Form::label("MainProductName","মেইন প্রোডাক্টের নাম",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-MainItemName-error">
        {!! Form::label("MainItemName","মেইন আইটেম নাম",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("MainItemName",null,["class"=>"form-control required"]) !!}
            <span id="MainItemName-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-LoanInstallation-error">
        {!! Form::label("LoanInstallation","ঋণ কিস্তি",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("LoanInstallation",null,["class"=>"form-control required"]) !!}
            <span id="LoanInstallation-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-InstallationServiceCharge-error">
        {!! Form::label("InstallationServiceCharge","কিস্তির সার্ভিস চার্জ",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-SavingInstallment-error">
        {!! Form::label("SavingInstallment","সঞ্চয় কিস্তি",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("SavingInstallment",null,["class"=>"form-control required"]) !!}
            <span id="SavingInstallment-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-MinimumLimit-error">
        {!! Form::label("MinimumLimit","সর্বনিম্ন সীমা",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("MinimumLimit",null,["class"=>"form-control required"]) !!}
            <span id="MinimumLimit-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-MaximumLimit-error">
        {!! Form::label("MaximumLimit","সর্বোচ্চ সীমা",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
    ...
    <div class="form-group required col-md-6" id="form-ServiceChargeCalculationMethod-error">
        {!! Form::label("ServiceChargeCalculationMethod","সার্ভিস চার্জ হিসাবের পদ্ধতি",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("ServiceChargeCalculationMethod",null,["class"=>"form-control required"]) !!}
            <span id="ServiceChargeCalculationMethod-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-PaymentFrequency-error">
        {!! Form::label("PaymentFrequency","পেমেন্ট ফ্রিকুয়েন্সি",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::number("PaymentFrequency",null,["class"=>"form-control required"]) !!}
            <span id="PaymentFrequency-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-InsuranceItemCode-error">
        {!! Form::label("InsuranceItemCode","ইন্সুরেন্স আইটেম কোড",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
            {!! Form::text("InsuranceItemCode",null,["class"=>"form-control required"]) !!}
            <span id="InsuranceItemCode-error" class="help-block"></span>
        </div>
    </div>
    <div class="form-group required col-md-6" id="form-InsuranceItemRate-error">
        {!! Form::label("InsuranceItemRate","ইন্সুরেন্স আইটেম রেট",["class"=>"control-label col-md-3"]) !!}
        <div class="col-md-6">
