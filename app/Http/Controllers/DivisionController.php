...
class DivisionController extends Controller
{
    ...
    public function postUpdate($id)
    {
        ...
        $division->DivisionCode = Input::get('DivisionCode');
        $division->testfield = Input::get('testfield');
        $division->unitprice = Input::get('unitprice');
        $division->save();
    ...
    public function postCreate()
    {
        $validator = Validator::make(Input::all(), [
            ...
            "testfield" => "required|unique:divisions",
