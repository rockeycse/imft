...
class PurposeController extends Controller
{
    ...
    public function getList()
    {
        ...
        Session::put('purpose_field', Input::has('field') ? Input::get('field') : (Session::has('purpose_field') ? Session::get('purpose_field') : 'name'));
        Session::put('purpose_sort', Input::has('sort') ? Input::get('sort') : (Session::has('purpose_sort') ? Session::get('purpose_sort') : 'asc'));
        $purposes = Purpose::where('name', 'like', '%' . Session::get('purpose_search') . '%')
    ...
    public function postUpdate($id)
    {
        ...
        if ($purpose->name != Input::get('name'))
            $rules += ['name' => 'required|unique:purposes'];
        ...
        $purpose->unitprice = Input::get('unitprice');
        $purpose->save();
